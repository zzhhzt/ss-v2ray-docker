...
[![shadowsocks-v2ray-docker metadata](https://images.microbadger.com/badges/image/boris1993/shadowsocks-v2ray-docker:v3.2.4-1.1.0.svg)](https://microbadger.com/images/boris1993/shadowsocks-v2ray-docker:v3.2.4-1.1.0)
[![shadowsocks-v2ray-docker tag](https://images.microbadger.com/badges/version/boris1993/shadowsocks-v2ray-docker:v3.2.4-1.1.0.svg)](https://microbadger.com/images/boris1993/shadowsocks-v2ray-docker:v3.2.4-1.1.0)
...
```bash
docker pull boris1993/shadowsocks-v2ray-docker:v3.2.4-1.1.0
```
...
docker run \
    ...
    -e PASSWORD=<password> \
    boris1993/shadowsocks-v2ray-docker:v3.2.4-1.1.0
```
...
services:
  shadowsocks-obfs-docker:
    image: boris1993/shadowsocks-v2ray-docker:v3.2.4-1.1.0
    restart: always
    ports:
